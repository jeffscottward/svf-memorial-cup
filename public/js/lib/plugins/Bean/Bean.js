  ...
  clearCanvas: function(redrawKeyFrame) {
    this.withContext(function(context) {
      if (redrawKeyFrame !== false && this.currentKeyFrame != undefined) {
        context.putImageData(this.currentKeyFrame, 0, 0, this.currentKeyFrame.height, this.currentKeyFrame.width, this.canvas.height, this.canvas.width);
      } else {
